<?php 
    ...
    if($responseCode == 200) {
		...
		$result = "<p class=\"center_message\">No calculations performed yet.</p>";
    } else {
        $result = "<p class=\"center_message\">An error occured retrieving your calculation history.</p>";
    }
	echo $result;